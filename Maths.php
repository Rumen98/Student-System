...
<input type="submit" name="submit" value="Search">
    ...
    <div class="wrapper">
        ...
        $sql="select * from students_assessments LEFT JOIN students on sa_student_id=student_id LEFT JOIN subjects on sa_subject_id=subject_id where student_fname like '%$search_value%' AND sa_subject_id=1 LIMIT $offset, $no_of_records_per_page ";
        $res=$conn->query($sql);
